export default function FloorPlanSVG() {
  return (
    ...
    >
      ...
      <text x="105" y="118" fill="#C9A84C" fontSize="14" fontWeight="bold" fontFamily="Inter,sans-serif" textAnchor="middle">Гостиная</text>
      <text x="105" y="136" fill="#8A8A8A" fontSize="11" fontFamily="Inter,sans-serif" textAnchor="middle">28.5 м²</text>

      {/* Kitchen */}
      <rect x="270" y="30" width="180" height="120" fill="rgba(201,168,76,0.03)" stroke="#C9A84C" strokeWidth="1.5"/>
      <text x="360" y="84" fill="#C9A84C" fontSize="14" fontWeight="bold" fontFamily="Inter,sans-serif" textAnchor="middle">Кухня</text>
      <text x="360" y="102" fill="#8A8A8A" fontSize="11" fontFamily="Inter,sans-serif" textAnchor="middle">12.0 м²</text>

      {/* Hallway */}
      <rect x="270" y="150" width="180" height="80" fill="rgba(201,168,76,0.03)" stroke="#C9A84C" strokeWidth="1.5"/>
      <text x="360" y="186" fill="#C9A84C" fontSize="14" fontWeight="bold" fontFamily="Inter,sans-serif" textAnchor="middle">Коридор</text>
      <text x="360" y="204" fill="#8A8A8A" fontSize="11" fontFamily="Inter,sans-serif" textAnchor="middle">8.3 м²</text>

      {/* Bedroom 1 */}
      <rect x="30" y="230" width="200" height="180" fill="rgba(201,168,76,0.03)" stroke="#C9A84C" strokeWidth="1.5"/>
      <text x="130" y="318" fill="#C9A84C" fontSize="14" fontWeight="bold" fontFamily="Inter,sans-serif" textAnchor="middle">Спальня 1</text>
      <text x="130" y="336" fill="#8A8A8A" fontSize="11" fontFamily="Inter,sans-serif" textAnchor="middle">18.2 м²</text>

      {/* Bedroom 2 */}
      <rect x="230" y="230" width="160" height="145" fill="rgba(201,168,76,0.03)" stroke="#C9A84C" strokeWidth="1.5"/>
      <text x="310" y="300" fill="#C9A84C" fontSize="14" fontWeight="bold" fontFamily="Inter,sans-serif" textAnchor="middle">Спальня 2</text>
      <text x="310" y="318" fill="#8A8A8A" fontSize="11" fontFamily="Inter,sans-serif" textAnchor="middle">14.8 м²</text>

      {/* Bathroom */}
      <rect x="390" y="230" width="60" height="145" fill="rgba(201,168,76,0.03)" stroke="#C9A84C" strokeWidth="1.5"/>
      <text x="420" y="298" fill="#C9A84C" fontSize="11" fontWeight="bold" fontFamily="Inter,sans-serif" textAnchor="middle">Ванная</text>
      <text x="420" y="314" fill="#8A8A8A" fontSize="10" fontFamily="Inter,sans-serif" textAnchor="middle">5.5 м²</text>
      ...
      <text x="240" y="434" fill="#8A8A8A" fontSize="9" fontFamily="Inter,sans-serif" textAnchor="middle" opacity="0.6">Общая ширина: ~12.5 м</text>
    </svg>
  )
}
