      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-3xl sm:text-4xl font-bold mb-4">
            До <span className="text-[#8A8A8A]">&</span> <span className="text-[#C9A84C]">После</span>
          </h2>
          <p className="text-[#8A8A8A] max-w-xl mx-auto">
            Посмотрите на разительное преображение от базовой планировки до Premium-визуализации.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          ...
          <div className="bg-[#111111] border border-[rgba(201,168,76,0.15)] rounded-xl overflow-hidden">
            <div className="px-4 py-3 border-b border-[rgba(201,168,76,0.1)] flex items-center gap-2">
              <span className="text-[#8A8A8A] text-xs font-medium uppercase tracking-wider">До — Оригинальный скан</span>
            </div>
            <div className="p-6 flex items-center justify-center min-h-[280px] bg-[#0d0d0d]">
              <svg viewBox="0 0 300 220" className="w-full max-w-sm opacity-60">
                ...
                <text x="35" y="55" fill="#555" fontSize="9" fontFamily="monospace">ГОСТИНАЯ</text>
                <text x="130" y="37" fill="#555" fontSize="9" fontFamily="monospace">КУХНЯ</text>
                <text x="20" y="140" fill="#555" fontSize="9" fontFamily="monospace">СПАЛЬНЯ 1</text>
                <text x="110" y="140" fill="#555" fontSize="9" fontFamily="monospace">СПАЛЬНЯ 2</text>
                <text x="130" y="83" fill="#555" fontSize="8" fontFamily="monospace">КОРИДОР</text>
              </svg>
            </div>
          </div>
          ...
          <div className="bg-[#111111] border border-[rgba(201,168,76,0.4)] rounded-xl overflow-hidden shadow-lg shadow-[#C9A84C]/10">
            <div className="px-4 py-3 border-b border-[rgba(201,168,76,0.2)] flex items-center gap-2">
              <span className="text-[#C9A84C] text-xs font-medium uppercase tracking-wider">После — Premium-визуализация</span>
            ...
            <div className="p-6 flex items-center justify-center min-h-[280px] bg-[#0d0d0d]">
              <svg viewBox="0 0 300 220" className="w-full max-w-sm">
                ...
                <text x="28" y="50" fill="#C9A84C" fontSize="10" fontWeight="bold" fontFamily="Inter,sans-serif">Гостиная</text>
                <text x="40" y="64" fill="#8A8A8A" fontSize="8" fontFamily="Inter,sans-serif">28.5 м²</text>
                <text x="130" y="35" fill="#C9A84C" fontSize="10" fontWeight="bold" fontFamily="Inter,sans-serif">Кухня</text>
                <text x="138" y="48" fill="#8A8A8A" fontSize="8" fontFamily="Inter,sans-serif">12.0 м²</text>
                <text x="18" y="138" fill="#C9A84C" fontSize="10" fontWeight="bold" fontFamily="Inter,sans-serif">Спальня 1</text>
                <text x="25" y="152" fill="#8A8A8A" fontSize="8" fontFamily="Inter,sans-serif">18.2 м²</text>
                <text x="108" y="138" fill="#C9A84C" fontSize="10" fontWeight="bold" fontFamily="Inter,sans-serif">Спальня 2</text>
                <text x="120" y="152" fill="#8A8A8A" fontSize="8" fontFamily="Inter,sans-serif">14.8 м²</text>
                <text x="130" y="80" fill="#C9A84C" fontSize="10" fontWeight="bold" fontFamily="Inter,sans-serif">Коридор</text>
                <text x="136" y="92" fill="#8A8A8A" fontSize="8" fontFamily="Inter,sans-serif">8.3 м²</text>
