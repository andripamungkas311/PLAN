    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-16">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center py-20">
        <div className="inline-flex items-center gap-2 bg-[#111111] border border-[rgba(201,168,76,0.3)] rounded-full px-4 py-1.5 text-xs text-[#C9A84C] mb-8 font-medium">
          ...
          Профессиональный инструмент визуализации планировок
        </div>

        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight mb-6 tracking-tight">
          Превратите стандартную планировку
          <br />
          <span className="text-[#C9A84C]">в стильный Premium-макет</span>
          <br />
          за одну минуту
        </h1>

        <p className="text-[#8A8A8A] text-lg max-w-2xl mx-auto mb-10 leading-relaxed">
          Загрузите планировку, позвольте ИИ распознать комнаты и стены, затем настройте
          с помощью нашего редактора. Экспортируйте в высоком разрешении для презентаций.
        </p>
        ...
        <p className="mt-6 text-[#8A8A8A] text-xs">Регистрация не требуется · Бесплатно</p>
        ...
        <div className="mt-16 relative mx-auto max-w-3xl">
          <div className="bg-[#111111] border border-[rgba(201,168,76,0.25)] rounded-2xl overflow-hidden shadow-2xl shadow-[#C9A84C]/5">
            <div className="flex items-center gap-1.5 px-4 py-3 border-b border-[rgba(201,168,76,0.15)]">
              ...
              <span className="ml-3 text-[#8A8A8A] text-xs">FloorPlan Studio — Редактор</span>
            </div>
            <div className="p-6 bg-[#0d0d0d] min-h-[320px] flex items-center justify-center">
              <svg viewBox="0 0 600 400" className="w-full max-w-xl" style={{ background: '#0d0d0d' }}>
                ...
                <text x="90" y="95" fill="#C9A84C" fontSize="13" fontWeight="bold" fontFamily="Inter,sans-serif">Гостиная</text>
                <text x="100" y="113" fill="#8A8A8A" fontSize="10" fontFamily="Inter,sans-serif">28.5 м²</text>
                {/* Kitchen */}
                <rect x="240" y="20" width="160" height="110" fill="none" stroke="#C9A84C" strokeWidth="1.5"/>
                <text x="285" y="68" fill="#C9A84C" fontSize="13" fontWeight="bold" fontFamily="Inter,sans-serif">Кухня</text>
                <text x="298" y="84" fill="#8A8A8A" fontSize="10" fontFamily="Inter,sans-serif">12.0 м²</text>
                {/* Hallway */}
                <rect x="240" y="130" width="160" height="70" fill="none" stroke="#C9A84C" strokeWidth="1.5"/>
                <text x="282" y="162" fill="#C9A84C" fontSize="13" fontWeight="bold" fontFamily="Inter,sans-serif">Коридор</text>
                <text x="292" y="178" fill="#8A8A8A" fontSize="10" fontFamily="Inter,sans-serif">8.3 м²</text>
                {/* Bedroom 1 */}
                <rect x="20" y="200" width="180" height="160" fill="none" stroke="#C9A84C" strokeWidth="1.5"/>
                <text x="65" y="275" fill="#C9A84C" fontSize="13" fontWeight="bold" fontFamily="Inter,sans-serif">Спальня 1</text>
                <text x="78" y="293" fill="#8A8A8A" fontSize="10" fontFamily="Inter,sans-serif">18.2 м²</text>
                {/* Bedroom 2 */}
                <rect x="200" y="200" width="140" height="130" fill="none" stroke="#C9A84C" strokeWidth="1.5"/>
                <text x="235" y="260" fill="#C9A84C" fontSize="13" fontWeight="bold" fontFamily="Inter,sans-serif">Спальня 2</text>
                <text x="245" y="278" fill="#8A8A8A" fontSize="10" fontFamily="Inter,sans-serif">14.8 м²</text>
                {/* Bathroom */}
                <rect x="340" y="200" width="60" height="130" fill="none" stroke="#C9A84C" strokeWidth="1.5"/>
                <text x="345" y="258" fill="#C9A84C" fontSize="10" fontWeight="bold" fontFamily="Inter,sans-serif">Ванная</text>
                <text x="344" y="272" fill="#8A8A8A" fontSize="9" fontFamily="Inter,sans-serif">5.5 м²</text>
                {/* Door markers */}
          ...
          <div className="absolute -bottom-4 left-1/2 -translate-x-1/2 text-[#8A8A8A] text-xs bg-[#111111] border border-[rgba(201,168,76,0.2)] px-4 py-1.5 rounded-full">
            Предпросмотр Premium-визуализации
          </div>
        </div>
      </div>
    </section>
